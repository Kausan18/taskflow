...
export const LoginForm = () => {
  ...
  // FIX: Google OAuth button was purely decorative — now triggers the backend OAuth redirect.
  // The backend route /api/auth/google starts Supabase's Google OAuth flow.
  // After Google callback, Supabase redirects to /api/auth/google/callback which
  // issues the JWT pair and redirects the browser to /tasks.
  ...
  return (
    <div className="w-full">
      ...
      <div className="mt-6 flex flex-col space-y-4">
        ...
        {/* FIX: was a dead button with no onClick — now triggers backend OAuth redirect */}
        <button
          type="button"
