...
export const TaskCard = ({ task, onClick }) => {
  ...
  return (
    <div
      ...
      className="bg-[#242830] rounded-xl p-4 border border-transparent hover:border-[#6366f1] transition-colors cursor-grab active:cursor-grabbing flex flex-col space-y-3 shadow-none hover:shadow-lg"
    >
      ...
      <div className="flex items-center justify-between pt-2">
        {task.assignee ? (
          ...
          <div className="w-6 h-6 rounded-full bg-[#1e2128] border border-[#2d3240] border-dashed flex items-center justify-center">
          </div>
        )}

        <div className={`flex items-center space-x-1 ${task.isOverdue ? 'text-red-400' : 'text-gray-400'}`}>
